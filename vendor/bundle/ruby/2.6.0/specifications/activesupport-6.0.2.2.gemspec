# -*- encoding: utf-8 -*-
# stub: activesupport 6.0.2.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v6.0.2.2/activesupport/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v6.0.2.2/", "mailing_list_uri" => "https://groups.google.com/forum/#!forum/rubyonrails-talk", "source_code_uri" => "https://github.com/rails/rails/tree/v6.0.2.2/activesupport" } if s.respond_to? :metadata=
